...
public class OkHttpUtils {
	...
	public static void main(String[] args) {
		...
		final MNetCallback callback = new MNetCallback();
		
		httpUtils.doGet("https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=6228480402564890018&cardBinCheck=true", null, null, callback);
	}
	
	public static class MNetCallback implements NetCallback{
		...
		@Override
		public void onSuccess(int code, String content) {
			System.out.println("onSuccess code : "+code+",msg :"+content);
		}
