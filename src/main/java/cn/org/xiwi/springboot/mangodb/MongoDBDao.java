...
/**
 * 类名： MongoDBDao 作者：lky
 */
public interface MongoDBDao {
	/**
	 * 
	 * 方法名：getDb 作者：lky 描述：获取指定的mongodb数据库
	 * 
	 * @param dbName
	 * @return
	 */
	...
	/**
	 * 
	 * 方法名：getCollection 作者：lky 描述：获取指定mongodb数据库的collection集合
	 * 
	 * @param dbName
	 *            数据库名
	...
	/**
	 * 
	 * 方法名：inSert 作者：lky 描述：向指定的数据库中添加给定的keys和相应的values
	 * 
	 * @param dbName
	 * @param collectionName
	 * @param keys
	...
	/**
	 * 
	 * 方法名：delete 作者：lky 描述：删除数据库dbName中，指定keys和相应values的值
	 * 
	 * @param dbName
	 * @param collectionName
	 * @param keys
	...
	/**
	 * 
	 * 方法名：find 作者：lky 描述：从数据库dbName中取出相应数目的数据
	 * 
	 * @param dbName
	 * @param collectionName
	 * @param keys
	...
	/**
	 * 
	 * 方法名：update 作者：lky 描述：更新数据库dbName，用指定的newValue更新oldValue
	 * 
	 * @param dbName
	 * @param collectionName
	 * @param oldValue
	...
	/**
	 * 
	 * 方法名：isExit 作者：lky 描述：判断给定的keys和相应的values在指定的dbName的collectionName集合中是否存在
	 * 
	 * @param dbName
	 * @param collectionName
	 * @param keys
