...
public class ReflectionUtils {
	...
	public static Query getQueryObj(final Object obj) {
		...
		Query query = new Query();// 存放日期范围或者确定日期
					...
					if (field.getType().getSimpleName().equals("Date")) {
						if (field.getName().toLowerCase().startsWith("begin")) {
							...
							if (beginName.isEmpty()) {
								...
								beginName = toLowerCaseFirstOne(beginName);
						...
						if (field.getName().toLowerCase().startsWith("end")) {
							...
							if (endName.isEmpty()) {
								...
								endName = toLowerCaseFirstOne(endName);
	...
	public static void main(String[] a) {
		...
		System.out.println(toLowerCaseFirstOne("ASSS"));
